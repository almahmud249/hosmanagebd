...
class LoginController extends Controller
{
    ...
    */
    ...
    public function login(Request $request)
    {
        ...
        if($doc==null){
             $request->session()->flash('msg', 'Incorrect password or email !!');

            return redirect('/doctor/login_page')->with(['status'=>'Invalid credentials']);
    ...
    {
        return redirect('/doctor/login_page');
    }
