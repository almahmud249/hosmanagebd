...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js"
        ...
        href="{{ asset('assets/vendor/datePicker/css/bootstrap-datetimepicker.min.css') }}">
    <!-- =======================================================
...
<body>
                    ...
                    <div class="row">
                        ...
                        <div class="col" style="width: 1200px">
                            <div class="container">
                                ...
                                @endif
                                <form method="post" action="{{ route('apt') }}">
                                    @csrf
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mt-3">
                                            <div class="form-group">
                                                <div class="cal-icon">
                                                    <input type="text" name="date" class="form-control datetimepicker" id="datetimepicker4"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 form-group mt-3">
                                            <select name="department" id="department" required class="form-select">
                                                ...
                                                @foreach ($dpt as $row)
                                                    <option value="{{ $row->id }}">{{ $row->department }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            <div class="validate"></div>
                                        ...
                                        <div class="col-md-6 form-group mt-3">
                                            <select name="doctor" id="doctor" class="doctor form-select" required>
                                    ...
                                    <div class="text-center"><button class="text-white btn btn-info mt-3"
                                            type="submit">Make an
    ...
    <main id="main">
        ...
        {{-- <section id="appointment" class="appointment section-bg">
            <div class="container" data-aos="fade-up">
                ...
                <form action="{{ URL::to('insert_appointment_user') }}" method="post" role="form"
                  ...
                  <p>Velit veniam ipsa sit nihil blanditiis mollitia natus.</p>
                    ...
                    <div class="col-lg-8">
                        <div class="tab-content">
                            <div class="tab-pane active show" id="DERMATOLOGY">
                                <h3>DERMATOLOGY</h3>
                            ...
                            <div class="tab-pane" id="HAEMODIALYSIS">
                                <h3>HAEMODIALYSIS</h3>
                                <p class="font-italic">Qui laudantium consequatur laborum sit qui ad sapiente dila parde
                                    sonata raqer a videna mareta paulona marka</p>
                            ...
                            <div class="tab-pane" id="ONCOLOGY">
                                <h3>ONCOLOGY</h3>
                                <p class="font-italic">Qui laudantium consequatur laborum sit qui ad sapiente dila parde
                                    sonata raqer a videna mareta paulona marka</p>
                        ...
                        <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                            <div class="member" data-aos="fade-up" data-aos-delay="100">
                                <div class="member-img">
                                    <img src="{{ URL::to($row->profile_photo) }}" class="img-fluid" alt="">
                                    <div class="social">
        ...
        <section id="faq" class="faq section-bg">
            <div class="container" data-aos="fade-up">
                ...
                <ul class="faq-list" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <li>
                        <a data-bs-toggle="collapse" class="" data-bs-target="#faq1">Non consectetur a erat nam at
                            lectus urna duis? <i class="icofont-simple-up"></i></a>
                    ...
                    <li>
                        <a data-bs-toggle="collapse" data-bs-target="#faq2" class="collapsed">Feugiat scelerisque varius
                            morbi enim nunc faucibus a pellentesque? <i class="icofont-simple-up"></i></a>
                    ...
                    <li>
                        <a data-bs-toggle="collapse" data-bs-target="#faq4" class="collapsed">Ac odio tempor orci
                            dapibus. Aliquam eleifend mi in nulla? <i class="icofont-simple-up"></i></a>
                    ...
                    <li>
                        <a data-bs-toggle="collapse" data-bs-target="#faq5" class="collapsed">Tempus quam pellentesque
                            nec nam aliquam sem et tortor consequat? <i class="icofont-simple-up"></i></a>
    ...
    <script src="{{ asset('assets/vendor/datePicker/js/moment.min.js') }}"></script>
    <script src="{{ asset('assets/vendor/datePicker/js/bootstrap-datetimepicker.min.js') }}"></script>
</body>
                ...
                $.get('{{ url('/department?dpt_id=') }}' + id)
                    .then(function(data) {
                        ...
                        data.forEach(function(row) {
                            ...
                            s += '<option value="' + row.username + '">' + row.username +
                                '</option>'
                        })
