            ...
            <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        ...
                        <form method="post" action="{{ URL::to('update_appointment_data/'.$dt->id) }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Patient Name</label>
                                        <input class="form-control" value="{{ $dt->name }}" type="text" name="name">
                                        @error('name')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="select" name="department">
                                            ...
                                            @isset($dept)
                                                @foreach ($dept as $row)
                                                    <option value="{{ $row->department }}" @if ($row->department == $dt->department) {{ 'selected' }} @endif>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="select" name="doctor">
                                            ...
                                            @isset($doc)
                                                @foreach ($doc as $row)
                                                    <option value="{{ $row->username }} " @if ($row->username == $dt->doctor) {{ 'selected' }} @endif>{{ $row->username }}
                                                    </option>
                                                @endforeach
                                            @endisset
                                        </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="email" name="email" value="{{ $dt->email }}">
                                        @error('email')
                                            <p style="color: red">{{ $message }}</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="phone" value="{{ $dt->phone }}">
                                        @error('phone')
                                            <p style="color: red">{{ $message }}</p>
                            ...
                            <div class="form-group">
                                ...
                                <textarea cols="30" rows="4" class="form-control"
                                    name="message">{{ $dt->message }}</textarea>
                            </div>
                            {{-- <div class="form-group">
